...
- Bloque de descubrimiento semanal que rota automáticamente una idea distinta cada siete días, sin añadir un feed, una base de datos ni un deploy manual. La idea lleva a una búsqueda actual de Amazon; las fichas concretas solo se muestran cuando la API autorizada devuelve datos válidos.
